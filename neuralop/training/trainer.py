...
class Trainer:
    ...
    def __init__(
        ...
        *,
        ...
        # Neighbor search logging
        # self.neighbor_logger = NeighborSearchLogger(log_dir="./neighbor_logs")
        # self.first_batch_train_captured = False
        # self.first_batch_test_captured = False
        # self.gno_in_neighbors_train = None
        # self.gno_in_query_train = None
        # self.gno_in_data_train = None
        # self.gno_out_neighbors_train = None
        # self.gno_out_query_train = None
        # self.gno_out_data_train = None
        # self.gno_in_neighbors_test = None
        # self.gno_in_query_test = None
        # self.gno_in_data_test = None
        # self.gno_out_neighbors_test = None
        # self.gno_out_query_test = None
        # self.gno_out_data_test = None
    ...
    def train(
        ...
        for epoch in range(self.start_epoch, self.n_epochs):
            # Reset first batch flags for new epoch
            # self.first_batch_train_captured = False
            # self.first_batch_test_captured = False
            ...
            if epoch % self.eval_interval == 0:
                ...
                # Log neighbor search results for the epoch
                # self.neighbor_logger.log_epoch(
                #     gno_in_neighbors_train=self.gno_in_neighbors_train,
                #     gno_in_query_points_train=self.gno_in_query_train,
                #     gno_in_data_points_train=self.gno_in_data_train,
                #     gno_out_neighbors_train=self.gno_out_neighbors_train,
                #     gno_out_query_points_train=self.gno_out_query_train,
                #     gno_out_data_points_train=self.gno_out_data_train,
                #     gno_in_neighbors_test=self.gno_in_neighbors_test,
                #     gno_in_query_points_test=self.gno_in_query_test,
                #     gno_in_data_points_test=self.gno_in_data_test,
                #     gno_out_neighbors_test=self.gno_out_neighbors_test,
                #     gno_out_query_points_test=self.gno_out_query_test,
                #     gno_out_data_points_test=self.gno_out_data_test,
                #     epoch=epoch,
                # )
    ...
    def evaluate(
        ...
        with torch.no_grad():
            for idx, sample in enumerate(data_loader):
                ...
                # if idx == 0 and not self.first_batch_test_captured and hasattr(self.model, 'last_gno_in_neighbors'):
                #     self.first_batch_test_captured = True
                #     self.gno_in_neighbors_test = self.model.last_gno_in_neighbors
                #     self.gno_in_query_test = self.model.last_gno_in_query
                #     self.gno_in_data_test = self.model.last_gno_in_data
                #     self.gno_out_neighbors_test = self.model.last_gno_out_neighbors
                #     self.gno_out_query_test = self.model.last_gno_out_query
                #     self.gno_out_data_test = self.model.last_gno_out_data
    ...
    def train_one_batch(self, idx, sample, training_loss):
        ...
        # Capture first batch neighbor data for logging
        # if idx == 0 and not self.first_batch_train_captured and hasattr(self.model, 'last_gno_in_neighbors'):
        #     self.first_batch_train_captured = True
        #     self.gno_in_neighbors_train = self.model.last_gno_in_neighbors
        #     self.gno_in_query_train = self.model.last_gno_in_query
        #     self.gno_in_data_train = self.model.last_gno_in_data
        #     self.gno_out_neighbors_train = self.model.last_gno_out_neighbors
        #     self.gno_out_query_train = self.model.last_gno_out_query
        #     self.gno_out_data_train = self.model.last_gno_out_data
