...
from .pt_dataset_jax import PTDataset
...
class DataLoader:
    """Simple batching data loader replacing torch.utils.data.DataLoader."""
    ...
    def __iter__(self):
        ...
        for start in range(0, n, self.batch_size):
            yield self.dataset[indices[start:start + self.batch_size]]
